...
// DeCompiled : CMPPDeliverMessage.class
...
public class CMPPDeliverMessage extends CMPPMessage
{
    ...
    {
        byte tmpId[] = new byte[21];
        System.arraycopy(buf, 46, tmpId, 0, 21);
        return (new String(tmpId)).trim();
    }
    ...
    public byte[] getStatusMsgId()
    {
        if(deliverType == 1)
        {
            ...
            System.arraycopy(buf, 69, tmpId, 0, 8);
            return tmpId;
        } else
        {
            return null;
    ...
    public String getStat()
    {
        if(deliverType == 1)
        {
            ...
            System.arraycopy(buf, 77, tmpStat, 0, 7);
    ...
    public Date getDoneTime()
    {
        ...
        {
            byte tmpbyte[] = new byte[2];
            System.arraycopy(buf, 94, tmpbyte, 0, 2);
            String tmpstr = new String(tmpbyte);
            int tmpYear = 2000 + Integer.parseInt(tmpstr);
    ...
    public String getDestTerminalId()
    {
        ...
        {
            byte tmpId[] = new byte[21];
            System.arraycopy(buf, 104, tmpId, 0, 21);
    ...
    public int getSMSCSequence()
    {
        if(deliverType == 1)
        {
            int tmpSequence = TypeConvert.byte2int(buf, 125);
            return tmpSequence;
        } else
        {
            return -1;
