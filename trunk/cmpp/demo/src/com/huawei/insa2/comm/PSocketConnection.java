...
// DeCompiled : PSocketConnection.class
...
//            PLayer, PException, PEvent, PWriter, 
//            PReader, PMessage
...
public abstract class PSocketConnection extends PLayer
{
    ...
    protected void init(Args args)
    {
        ...
        if(heartbeatInterval > 0)
        {
            ...
            {
                super(String.valueOf(String.valueOf(name)).concat("-heartbeat"));
                setState_(PSocketConnection.HEARTBEATING);
            }
            }
    ...
    {
        return String.valueOf(String.valueOf((new StringBuffer("PSocketConnection:")).append(name).append('(').append(host).append(':').append(port).append(')')));
    }
