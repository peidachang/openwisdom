...
// DeCompiled : CMPPSubmitMessage.class
...
public class CMPPSubmitMessage extends CMPPMessage
{
    ...
    public CMPPSubmitMessage(int pk_Total, int pk_Number, int registered_Delivery, int msg_Level, String service_Id, int fee_UserType, String fee_Terminal_Id, 
        ...
        throws IllegalArgumentException
    {
        ...
        System.arraycopy(src_Terminal_Id.getBytes(), 0, buf, 107, src_Terminal_Id.length());
        buf[128] = (byte)dest_Terminal_Id.length;
        int i = 0;
        for(i = 0; i < dest_Terminal_Id.length; i++)
            System.arraycopy(dest_Terminal_Id[i].getBytes(), 0, buf, 129 + i * 21, dest_Terminal_Id[i].length());
